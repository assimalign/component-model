...
internal sealed class MapperActionDefault : IMapperAction
{
    ...
    public MapperActionDefault(Action<IMapperContext> configure) => this.configure = configure;
...
internal sealed class MapperActionDefault<TTarget, TSource> : IMapperAction
{
    ...
    public MapperActionDefault(Action<TTarget, TSource> configure) => this.configure = configure;
    public int Id => this.GetHashCode();
